...
FILE=/projects/roab9675/SMAP/9km_points_Final/SMAP_9km_Points_iter99999
...
rm -r /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}
	...
	cp /scratch/summit/roab9675/SMAP/Gridded_ESMAP/${stringlat}/${stringlon}/Hydrus_FINAL/*.IN /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}
	cp /scratch/summit/roab9675/SMAP/Gridded_ESMAP/${stringlat}/${stringlon}/Hydrus_FINAL/*.DAT /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}
	cp /scratch/summit/roab9675/SMAP/Gridded_ESMAP/${stringlat}/${stringlon}/Hydrus_FINAL/*.TXT /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}
...
echo "cd /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}/"  >> /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}/hydrus_${stringlat}_${stringlon}.sh
echo "cp /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}/*.OUT /scratch/summit/roab9675/SMAP/Gridded_ESMAP/${stringlat}/${stringlon}/Hydrus_FINAL/"  >> /scratch/summit/roab9675/SMAP/ESMAP_Calc/tmp_${stringlat}_${stringlon}/hydrus_${stringlat}_${stringlon}.sh
