...
for($year=$startyear; $year<=$endyear; $year++) {
  ...
  $IN_FILE=sprintf("/Volumes/REESEN/SMAP/Validation_Data/GLEAM_9km/Raw/%04d/E_%04d_GLEAM_v3.3a.nc",$year,$year);
  print "$IN_FILE\n";
            $outdir="/Volumes/REESEN/SMAP/Validation_Data/GLEAM_9km/ET/";
   print "$outdir\n";
      ...
      $Out_File=sprintf("E_9km_%04d_GLEAM_v3.3a.nc",$year);
