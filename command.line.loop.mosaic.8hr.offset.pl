...
for($year=$startyear;$year<=$endyear;$year++) {
    ...
    for ($month=1;$month<=1;$month++) {
        ...
        $outdir=sprintf("/Volumes/REESEN/SMAP/Validation_Data/NLDAS2/MOSAIC_8hr_Offset/%04d/%02d/",$year,$month);
        ...
        for ($day=1;$day<=2;$day++) {
            ...
            if ($day>1) {
                ...
                $filename_01=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[0123]00.nc",$year,$month,$year,$month,$day);
                $filename_02=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[456789]00.nc",$year,$month,$year,$month,$day-1);
            ...
            if ($day==1&& $month>1) {
                ...
                $filename=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.0?00.nc",$year,$month,$year,$month,$day);
                $filename_01=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[0123]00.nc",$year,$month,$year,$month,$day);
                $filename_02=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[456789]00.nc",$year,$month_before,$year,$month_before,$day_before);
            ...
            if ($day==1 && $month==1) {
                ...
                $filename=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.0?00.nc",$year,$month,$year,$month,$day);
                $filename_01=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[0123]00.nc",$year,$month,$year,$month,$day);
                $filename_02=sprintf(" /Volumes/REESEN/SMAP/Validation_Data/NLDAS2/Mosaic/%04d/%02d/NLDAS_MOSAIC0125_H..A%04d%02d%02d.1[456789]00.nc",$year_before,$month_before,$year_before,$month_before,$day_before);
